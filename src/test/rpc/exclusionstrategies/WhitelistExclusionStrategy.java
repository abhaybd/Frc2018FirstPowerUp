package test.rpc.exclusionstrategies;

import com.google.gson.ExclusionStrategy;
import com.google.gson.FieldAttributes;
import test.rpc.RPCResponse;
...
public class WhitelistExclusionStrategy implements ExclusionStrategy
{
    ...
    public boolean shouldSkipField(FieldAttributes fieldAttributes)
    {
        ...
        if(declaredClass.isPrimitive() || declaredClass.isArray() || declaringClass.equals(RPCResponse.class))
            return false;
