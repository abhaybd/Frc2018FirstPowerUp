...
public class RemoteSwerve
{
    ...
    public RemoteSwerve()
    {
        ...
        driveBase = new TrcSwerveDriveBase("SwerveDrive", width, length, gyro, lfModule, rfModule,
            lrModule, rrModule);

        taskMgr = TrcTaskMgr.getInstance();
    }

    public SwerveStatus getStatus(double x, double y, double turn, boolean inverted, double gyroAngle)
    {
        driveBase.swerveDrive_Cartesian(x, y, turn, inverted, gyroAngle);
